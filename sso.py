...
def run_sso_login(
    ...
    error_callback=None,
    success_callback=None   # ✅ NEW PARAM
):
    """
    Runs the interactive Tailscale SSO command, streams output,
    opens the browser for authentication, and notifies on success/failure.
    """
    ...
    def runner():
        try:
            ...
            for line in process.stdout:
                ...
                # ✅ Open browser only once when login URL appears
                if (
                    not browser_opened
            ...
            if connected:
                ...
                if success_callback:
                    success_callback()   # ✅ GUI gets notified here
